...
var unpressed = preload("res://assets/unpressed-tile.jpg")
...
func add_gameover_message() -> void:
	if is_draw:
		$GameOverMessage/Container/Label.text = "Empate!"
	else:
		$GameOverMessage/Container/Label.text = "Jugador " + player + " Gana!"
